...
def transforms_imagenet_train(
    ...
    if color_jitter is not None and not disable_color_jitter:
        ...
        secondary_tfl += [transforms.ColorJitter(brightness=32.0/255.0, saturation=0.5)]
...
def transforms_imagenet_eval(
    ...
    if crop_mode == 'squash':
        ...
        if scale_size[0] == scale_size[1]:
            ...
            tfl = [
                transforms.Resize(scale_size[0], interpolation=str_to_interp_mode('bilinear'))
            ]
        else:

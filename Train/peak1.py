...
def show_layer_mem(total_stages):
    ...
    for stages in total_stages:
        if len(stages.ops) > 1:
            ...
            for op, i, o, r in zip(stages.ops, stages.input_shapes, stages.output_shapes, stages.residuals):
                #print(op.name)    
...
def try_fusion(stages, input_buf_idx, output_buf_idx, N=28):
